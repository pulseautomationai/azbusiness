  ...
  static processCSVRow(row: CSVRow, fieldMapping: FieldMapping): { data: BusinessData | null; validation: ValidationResult } {
    try {
      ...
      const data: BusinessData = {
        ...
        email: fieldMapping.email ? row[fieldMapping.email] || undefined : undefined,
        website: fieldMapping.website ? row[fieldMapping.website] || undefined : undefined,
        description: fieldMapping.description ? row[fieldMapping.description] || undefined : undefined,
        shortDescription: fieldMapping.shortDescription ? row[fieldMapping.shortDescription] || undefined : undefined,
        category: fieldMapping.category ? row[fieldMapping.category] || undefined : undefined,
        rating: fieldMapping.rating ? (row[fieldMapping.rating] ? parseFloat(row[fieldMapping.rating]) : undefined) : undefined,
        reviewCount: fieldMapping.reviewCount ? (row[fieldMapping.reviewCount] ? parseInt(row[fieldMapping.reviewCount]) : undefined) : undefined,
        latitude: fieldMapping.latitude ? (row[fieldMapping.latitude] ? parseFloat(row[fieldMapping.latitude]) : undefined) : undefined,
        longitude: fieldMapping.longitude ? (row[fieldMapping.longitude] ? parseFloat(row[fieldMapping.longitude]) : undefined) : undefined,
        // Additional GMB fields
        imageUrl: fieldMapping.imageUrl ? row[fieldMapping.imageUrl] || undefined : undefined,
        favicon: fieldMapping.favicon ? row[fieldMapping.favicon] || undefined : undefined,
        reviewUrl: fieldMapping.reviewUrl ? row[fieldMapping.reviewUrl] || undefined : undefined,
        serviceOptions: fieldMapping.serviceOptions ? row[fieldMapping.serviceOptions] || undefined : undefined,
        fromTheBusiness: fieldMapping.fromTheBusiness ? row[fieldMapping.fromTheBusiness] || undefined : undefined,
        offerings: fieldMapping.offerings ? row[fieldMapping.offerings] || undefined : undefined,
        planning: fieldMapping.planning ? row[fieldMapping.planning] || undefined : undefined,
        hours: hours,
